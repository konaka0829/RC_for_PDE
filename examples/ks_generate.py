...
def save_plots(output_path: Path, x: np.ndarray, t: np.ndarray, u: np.ndarray) -> None:
...
def main(argv: list[str] | None = None) -> int:
    ...
    save_plots(output_path, result["x"], result["t"], result["u"])
    ...
    print(f"Plots: {output_path.with_suffix('.png')}")
    print(f"Plots: {output_path.with_suffix('.pdf')}")
    print(f"Plots: {output_path.with_suffix('.svg')}")
